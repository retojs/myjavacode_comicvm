...
var EditorPaintStrategy = {
    ...
    paintCharactersBBoxes: function (panel) {
		...
		// comicVM.EditorElements.character.bbox()  // is a EditorElementBuilder
		//   .panel(panel)
		//   .dim(panel.getActingCharactersBBox())
		//   .border(comicVM.EditorElements.border.bbox.active)
		//	 .type(comicVM.EditorElements.TYPE_BBOX_ACTIVE)
		// .create()
		
		/**
			EditorElementBuilder() {
